<form method="post">
    <table class="wp-list-table widefat fixed striped table-view-list posts">        
        <tr><td>STT</td><td><a href="<?php echo $employee_edit;?>&order=pc">PC</a></td><td>NHÂN VIÊN</td><td>NGÀY ACTIVE</td><td>NGÀY HẾT HẠN</td><td><a href="<?php echo $employee_edit;?>">SỐ NGÀY</a></td><td>THỨ TỰ</td><td>SỬA</td><td>XÓA</td></tr>    <?php
        ...
        $key_list = $wpdb->get_results("SELECT a.id_key, a.pc, a.ngayactive,a.ngayhethan, a.sort FROM $table_key_virus a, $table_part b WHERE a.pc = b.pc  ORDER BY a.$order");
